...
**** Pantalla *Lista paquetes*
     Muestra los paquetes asignados que todavía no han sido entregados o sin incidencia.
     
**** Pantalla *Entrega*
     
     Muestra información sobre el paquete en curso. Se puede realizar la entrega 
